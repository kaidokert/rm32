...
impl UartPeripheral for L431Uart {
    ...
    fn configure_dma_routing(&self) {
        ...
        dma.cselr.modify(|r, w| unsafe { w.bits((r.bits() & !(0xF << 12)) | (2 << 12)) });
    }
...
impl L431TelemUart {
    pub fn init() -> Result<Self, InitError> { crate::telem_hal::GenericTelemUart::new_init(L431Uart) }
    pub fn post_init() -> Self { crate::telem_hal::GenericTelemUart::new_post_init(L431Uart) }
}
