//! L431 flash: field-style PAC, double-word programming, page-number erase.
...
pub struct L431Flash;

impl FlashPeripheral for L431Flash {
...
pub type FlashStorage = crate::flash::FlashStorage<L431Flash>;
